...
- The quick `verify`'s tests run 91–105 s against the rule's 60 (60–63 at M8.5's gate; M8 and M8.6 grew them): the slowest pins into the long set. (M8.5 gate, M8.7 gate)
- M8.7's gate stopped at Marcin's word before the perf A/B against 0.8.5, the e2e suites (`game`, `heat`, `life`, `city`, `boot`) and the balance: M8.6 and M8.7 together have no perf reading yet. The next gate's first job. (M8.7 gate)
