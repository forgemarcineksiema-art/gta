...
export { PALETTE, PED_TINTS, PED_COLORS, CITY_COLORS, ISLAND_COLORS } from './palette';
export { ASPHALT, DIRT, GRASS, SAND, SurfaceMap, type SurfaceKind, type SurfaceReader } from './city/surface';
