...
export class Island {
   ...
   */
  private propBlocked(x: number, z: number, yaw: number, hx: number, hz: number, kind?: PropKind, onRoute?: 'loose' | 'solid', keep?: { rings: readonly PropRing[]; route: readonly number[] }): boolean {
