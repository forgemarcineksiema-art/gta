...
export const BAKED_JOBS: Readonly<Record<number, readonly JobDef[]>> = {
  42: [
    ...
    { id: 26, kind: 'mayhem', x: 18, z: -650, yaw: -2.5175696006130366, targetX: 18, targetZ: -650, level: 15000, descriptor: -1, payout: 8000, limitSeconds: 60, heat: 15 },
    ...
    { id: 28, kind: 'mayhem', x: 432, z: -18, yaw: 0.7853981633974483, targetX: 432, targetZ: -18, level: 15000, descriptor: -1, payout: 8000, limitSeconds: 60, heat: 15 },
