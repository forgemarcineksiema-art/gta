...
export interface PoliceTuning {
   ...
   */
  arrest: { playerSpeed: number; releaseSpeed: number; range: number; rear: number; front: number; side: number; standby: number; decel: number; arrive: number; accel: number; keep: number; clear: number; detourSpeed: number; near: number; nearSpeed: number };
...
export const POLICE: PoliceTuning = {
  ...
  arrest: { playerSpeed: 6, releaseSpeed: 9, range: 60, rear: 5.6, front: 5.6, side: 3.2, standby: 12, decel: 6, arrive: 1.2, accel: 12, keep: 5, clear: 4, detourSpeed: 5, near: 10, nearSpeed: 7 },
