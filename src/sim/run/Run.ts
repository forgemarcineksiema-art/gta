...
export class Run {
  ...
  dropOff = -1;
  /** The car driven through the door when the garage does not own it yet (DESIGN.md §13.7, §14.6: any body), and its paint: the wall offers to keep it. Null otherwise. */
  hot: BodyId | null = null;
  hotPaint = 0;
